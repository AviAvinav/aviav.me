...
export const metadata: Metadata = {
	...
	robots: "/robots.txt",
	verification: {
		google: "2M6OQtRimjisnjp4JxpUvzLWn5qvzni9amjiiogi0ew",
	},
	appleWebApp: {
		capable: true,
		title: "Avi Avinav - Full Stack Developer",
	...
	return (
		<main className="relative z-0">
			<div className="text-zinc-400 selection:bg-emerald-200 selection:text-black bg-black relative">
				...
				<div id="about" className="w-screen z-10 flex flex-col px-10 sm:px-20 md:px-44 relative">
					...
					<p className="mt-8 text-gray-300 text-lg leading-10 xl:leading-[2.8rem] xl:text-xl font-medium">
						...
						the tech I use below.
					</p>
					<p className="mt-8 text-gray-300 text-lg leading-10 xl:leading-[2.8rem] xl:text-xl font-medium">
						I am an open-source enthusiast and have
						...
						{" "}when I find the time. Apart from my career, I enjoy gaming, reading novels, and
